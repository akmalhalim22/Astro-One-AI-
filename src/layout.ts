...
export function topbar(screen: string): string {
  const titles: Record<string, { title: string; sub: string }> = {
    ...
    campaign:  { title: 'Campaign Performance', sub: 'Post-Sales · Direct Sales · Q1 2025 · Google Sheets' },
    gamanalytics: { title: '<i class="fab fa-google" style="color:#4285f4;margin-right:6px"></i>GAM Analytics', sub: 'Google Ad Manager · Live · Fast with 5min cache' },
