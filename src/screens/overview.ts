...
async function loadOverviewKPIs(){
  ...
  if(kpiRes.ok){
    ...
    ovSetEl('ovRevSnapshot','<div class="text-muted fs12" style="text-align:center;padding:12px"><i class="fas fa-plug" style="color:#f59e0b;margin-right:5px"></i>Connect Google Sheets<br><a href="#" onclick="navigate(\x27apiconn\x27)" style="color:#60a5fa;font-size:10px">Set up in API Connections</a></div>');
  }
  ...
  if(gamRes.ok){
    ...
    ovSetEl('ovGAMSnapshot','<div class="text-muted fs12" style="text-align:center;padding:12px"><i class="fas fa-plug" style="color:#f59e0b;margin-right:5px"></i>Connect GAM API<br><a href="#" onclick="navigate(\x27apiconn\x27)" style="color:#60a5fa;font-size:10px">Set up in API Connections</a></div>');
  }
